...
# Tool : Pixie WPS 
# Create by : OneShotPin 0.0.2 (c) 2017 rofl0r
# Modified by : Tamzid
# Github : https://github.com/abukayuum
import sys
import subprocess
import os
import tempfile
...
print('''
\033[1;92m Moded By Tamzid
Github : abukayuum
One line Command :\nsudo python3 pixiewps.py -i wlan0 -K\n
For Help Type :\npython3 pixiewps.py --help\033[0m
''')
    ...
    def prompt_network(self) -> str:
        ...
        while True:
            try:
                ...
                print('Enter e, exit, stop to exit program')
                networkNo = input('Select target: ')
                # Refresh the list when user presses enter
                if networkNo.lower() in ('r', '0', ''):
                    return self.prompt_network()
                if networkNo.lower() in ('stop', 'e', 'exit'):
...
def usage():
    return """
OneShotPin 0.0.2 (c) 2017 rofl0r, modded by Tamzid
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='OneShotPin 0.0.2 (c) 2017 rofl0r, modded by Tamzid',
